py-protodb
-------------
A Python library that generates protobuffers and Python CRUDL (Create, Read, Update, Delete, List/Lookup) based on your
relational data model. The tool will generate code that supports either records or maps. Currently, it only supports Postgres. 
